...
// nachdem der Thread, der dran war, fertig ist, gibt er den Lock weiter mit notify()
...
public class Worker implements Runnable {
    ...
    private static boolean running = true; //für höfliches stoppen
        ...
        while (true) {
            synchronized (LOCK) {
                ...
                while (turn != threadID) {
                    ...
                    // Nach dem Aufwachen prüfen, ob wir fertig sind (counter bei 20 oder höfliches stoppen requested)
                ...
                // Anderen Thread dran nehmen lassen
                turn = 1 - threadID;

                // Anderen wartenden Thread aufwecken
                LOCK.notifyAll();

                // sleeper für Testzwecken
                try {
                    Thread.sleep(500);
                } catch (InterruptedException e) {
